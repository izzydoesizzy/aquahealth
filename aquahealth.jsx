...
function JarVisualization({ fillPercent, label, color }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
      ...
      <span style={{ fontSize: 10, color: "#5a7a8a", textAlign: "center", fontWeight: 600, lineHeight: 1.2, maxWidth: 72 }}>{label}</span>
    </div>
  );
}
          ...
          <div style={{ animation: "fadeUp 0.5s ease" }}>
            ...
            {activeTab === "health" && (
              <div style={{ ...cardStyle, animation: "fadeUp 0.3s ease" }}>
                ...
                <div style={{
                  marginTop: 16, padding: 14, background: "#fef6f0", borderRadius: 12,
